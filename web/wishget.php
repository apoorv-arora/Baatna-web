...
<div class="row">
  <div class="medium-6 medium-centered large-4 large-centered columns">
    <!--<form id="form" method="post" action="">-->
     <input  type="submit" class="button expanded button1" wish="" qual="<?php echo $access_token; ?>" value="Your Wishes">
     <input type="submit" class="button expanded button2" qual="<?php echo $access_token; ?>" value="Your Offers">
     <p class="info"></p>
   <!-- </form>
-->    </div>
    </div>
...
<div align="center">
<button class="load_more" qual="<?php echo $access_token; ?>" id="load_more_button">load More</button>
               ...
               success:function(user) 
                {
                  for(var i=0;i<user.length;i++)
                  {
                    ...
                    $('.info').append('<p>You wished</p>' +titl+ '<br> '+desc+ ' <br>'+requiredfor+ ' <br>'+timeofpost+ ' <br> ');
                  }
